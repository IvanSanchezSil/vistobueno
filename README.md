...
>   carga.
> - `reglas_unt.yaml` — formato **DSL** (autómatas/analizadores), **42 reglas**:
...
reglas_unt.yaml            # Reglas en formato DSL (42 reglas)
...
genera un documento "bueno" (40/42) y 42 mutaciones de una sola propiedad

...
1. `test_doc_bueno_pasa_43` — el documento bueno pasa exactamente 43/45
   reglas, y las únicas no pasadas son las documentadas en
   `EXCLUIDAS_BASE`.

2. `test_mutacion_afecta_solo_esa_regla` — para cada una de las 45 reglas,
...
def test_doc_bueno_pasa_43():
    """El documento base cumple 43/45: solo fallan los esquemas alternativos."""
...
def test_mutaciones_cubren_las_45_reglas():

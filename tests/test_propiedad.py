...
1. `test_doc_bueno_pasa_42` — el documento bueno pasa exactamente 42/44
   reglas, y las únicas no pasadas son las documentadas en
   `EXCLUIDAS_BASE`.

2. `test_mutacion_afecta_solo_esa_regla` — para cada una de las 44 reglas,
...
def test_doc_bueno_pasa_42():
    """El documento base cumple 42/44: solo fallan los esquemas alternativos."""
...
def test_mutaciones_cubren_las_44_reglas():
